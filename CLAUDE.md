...
graph TD
    ...
    click C "./lab/lab0/CLAUDE.md" "查看 lab0 模块文档"
    click D "./lab/lab1/CLAUDE.md" "查看 lab1 模块文档"
```
...
- 2026-04-03T12:40:33: 初始化仓库级 `CLAUDE.md`，补充模块索引、Mermaid 结构图、常用命令、高层架构与 AI 协作说明。
